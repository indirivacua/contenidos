...
\begin{frame}
  	...
  	\begin{itemize}
		...
		\item Cuando el sockect recibe una conexión spawnea el servicio y le pasa el socket
		\item No hay necesidad de definir dependencias entre servicios $\rightarrow$ se inician todos los sockets en primer medida
  	\end{itemize}
\end{frame}
