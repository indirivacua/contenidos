...
\begin{frame}{¿Qué es el \textit{kernel} Linux?}
  ...
  \item En una misma estructura de código fuente se da soporte a \alert{todas las arquitecturas}
...
\begin{frame}[fragile]{Consideración: certificados de seguridad}
\begin{itemize}
    \item A partir de la versión 3.7 del kernel existe la posibilidad de
        firmar criptográficamente los módulos del kernel.
    \item Esto puede fallar al utilizar un archivo .config basado en
        el de distribuciones como Debian GNU/Linux que asumen que
        habrá un par de claves generadas en un directorio específico.
    \item Para evitar este problema deshabilitaremos las opciones:
        \begin{lstlisting}
...
# uname -r | md5sum
    ...
    \item ¡Tienen tiempo hasta el Lunes 10 a las 15:00 horas!
 \end{itemize}
\end{frame}
